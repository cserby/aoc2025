...
object Day1 {
    ...
    private fun perform(state: Int, instruction: Instruction): Int =
    ...
    fun part1(input: String, startAt: Int = 50): Int {
    ...
    private fun clicks(state: Int, instruction: Instruction) = sequence {
        when (instruction.direction) {
            Direction.L ->
    ...
    fun part2(input: String, startAt: Int = 50): Int {
        return parse(input.lines()).fold(Pair(startAt, 0)) { (state, zeroes), instruction ->
