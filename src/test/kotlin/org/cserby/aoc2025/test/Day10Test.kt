...
class Day10Test {
    ...
    fun part2example1() {
        ...
        assert(machines[0].possiblePressPatternPrefix(listOf(2)))
        assert(machines[0].possiblePressPatternPrefix(listOf(1, 2)))
        assert(machines[0].possiblePressPatternPrefix(listOf(3, 1, 2)))
        assert(machines[0].possiblePressPatternPrefix(listOf(0, 3, 1, 2)))
//        assert(machines[0].possiblePressPatternPrefix(listOf(3, 0, 3, 1, 2)))
        assert(machines[0].possiblePressPatternPrefix(listOf(1, 3, 0, 3, 1, 2)))
